                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: Colors.red[
                                  200], // Set the background color of the error message container.
                              borderRadius: const BorderRadius.all(
                                Radius.circular(
                                    15), // Set the border radius of the error message container.
                              ),
                            ),
                            child: const Text(
                              ...
                              style: TextStyle(
                                color: Colors
                                    .white, // Set the text color of the error message.
                                fontSize: 14,
                              ),
                            ),
                          )
